...
node_config{
    ...
    //service_account = "pet-service-account@petproject-341413.iam.gserviceaccount.com"
   // service_account =  ["serviceAccount:${google_service_account.sp-name.email}"]
    service_account = google_service_account.sp-name.email
